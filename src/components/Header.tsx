...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 w-full z-50 bg-[#0a1628]/95 backdrop-blur-xl border-b border-[#C5A059]/10 transition-all duration-300">
      {/* Top Bar */}
      <div className="hidden lg:block bg-[#0a1628] border-b border-white/5 py-2">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center">
          <div className="flex items-center space-x-6 font-cinzel text-[10px] font-semibold uppercase tracking-wider text-gray-300">
          ...
          <div className="flex items-center space-x-5 font-cinzel text-[10px] font-semibold uppercase tracking-wider text-gray-300">
          ...
          <div className="hidden md:flex space-x-6 items-center">
            {navItems.map((item) => (
              <a
                key={item.label}
                href={item.href}
                className="font-cinzel text-[10px] font-semibold uppercase tracking-wider text-gray-300 hover:text-[#C5A059] transition duration-300"
              >
                {item.label}
              </a>
            ))}
            <Link
              ...
              className="font-cinzel font-bold border border-[#C5A059] text-[#C5A059] px-5 py-2.5 text-[10px] uppercase tracking-wider hover:bg-[#C5A059] hover:text-[#020617] transition duration-500 shadow-[0_0_15px_rgba(197,160,89,0.1)]"
            >
              Comienza Ahora
            </Link>
          </div>
