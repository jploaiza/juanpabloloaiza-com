...
import {
  ...
  MessageCircle, Mail, Plus, Pencil,
} from "lucide-react";
      ...
      <div className="bg-[#0a1628] border border-[#C5A059]/20 p-5 mb-6 relative">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-5">
          <div className="bg-[#020617] border border-[#C5A059]/10 p-3 text-center">
            <p className="text-[10px] font-cinzel text-gray-500 uppercase tracking-wide mb-1">Pack</p>
            <p className="text-[#C5A059] font-cinzel font-bold text-lg">{patient.pack_size}</p>
          </div>
          <div className="bg-[#020617] border border-[#C5A059]/10 p-3 text-center">
            <p className="text-[10px] font-cinzel text-gray-500 uppercase tracking-wide mb-1">Usadas</p>
            <p className="text-white font-cinzel font-bold text-lg">{patient.sessions_used}/{patient.pack_size}</p>
          </div>
          <div className="bg-[#020617] border border-[#C5A059]/10 p-3 text-center">
            <p className="text-[10px] font-cinzel text-gray-500 uppercase tracking-wide mb-1">Restantes</p>
            <p className={`font-cinzel font-bold text-lg ${sl <= 2 ? "text-yellow-400" : "text-emerald-400"}`}>{sl}</p>
          </div>
          <div className="bg-[#020617] border border-[#C5A059]/10 p-3 text-center">
        ...
        <div className="mt-4 h-1.5 bg-[#020617] border border-[#C5A059]/10">
          <div
            ...
            style={{ width: `${Math.min(100, Math.round((patient.sessions_used / patient.pack_size) * 100))}%` }}
          />
        </div>
