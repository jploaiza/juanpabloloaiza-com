...
export const metadata: Metadata = { title: "Blog Manager — JPL Academy" };
...
export default async function AcademyBlogManagerPage() {
  ...
  return (
    <main className="max-w-6xl mx-auto px-4 sm:px-6 pt-8 pb-20">
        ...
        <div className="grid grid-cols-3 gap-4 mb-8">
          {[
            { label: "Total posts", value: allPosts.length, icon: FileText, accent: "text-white" },
                ...
                <tbody>
                  {allPosts.map((post) => (
                    ...
                    >
                      ...
                      <td className="py-3">
                        <Link
                          href={`/academy/admin/blog/${post.id}/editar`}
