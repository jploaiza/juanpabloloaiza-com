    ...
    return [
      {
        ...
        headers: [
          ...
          { key: "Cross-Origin-Resource-Policy", value: "same-origin" },
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://challenges.cloudflare.com https://static.cloudflareinsights.com https://cdn.jotfor.ms https://*.jotform.com",
              "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://cdn.jotfor.ms https://*.jotform.com",
              "img-src 'self' data: blob: https://media.juanpabloloaiza.com https://res.cloudinary.com https://image.pollinations.ai https://images.pexels.com https://cdn.jotfor.ms https://*.jotform.com",
              "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://api.resend.com https://api.deepseek.com https://image.pollinations.ai https://challenges.cloudflare.com https://ipapi.co https://*.jotform.com https://cdn.jotfor.ms",
              "font-src 'self' https://fonts.gstatic.com https://cdn.jotfor.ms https://*.jotform.com",
              "media-src 'self' https://media.juanpabloloaiza.com blob:",
              "frame-src https://challenges.cloudflare.com https://form.jotform.com https://*.jotform.com",
